...
src/enet_rmii_udp_Z2_3.o: ../src/enet_rmii_udp_Z2_3.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	powerpc-eabivle-gcc "@src/enet_rmii_udp_Z2_3.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "src/enet_rmii_udp_Z2_3.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
