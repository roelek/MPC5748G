...
src/enet_rmii_udp_Z4_2.o: ../src/enet_rmii_udp_Z4_2.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	powerpc-eabivle-gcc "@src/enet_rmii_udp_Z4_2.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "src/enet_rmii_udp_Z4_2.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
